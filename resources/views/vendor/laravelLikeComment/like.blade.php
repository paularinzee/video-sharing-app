...
?>
<div class="laravel-like" style="font-size:20px;">
	...
	<span class="text-muted" id="{{ $like_item_id }}-total-like">{{ $data[$like_item_id.'total_like'] }}</span>
   ...
   <span class="text-muted" id="{{ $like_item_id }}-total-dislike">{{ $data[$like_item_id.'total_dislike'] }}</span>
</div>
