          ...
          <div class="col-lg-3" style="margin-bottom: 10px"> 
            ...
            <div class="card wow fadeIn" data-wow-delay="0.2s"> 
              ...
              <div class="card-block"> 
                ...
                <!--Text-->
                <p> <small class="text-muted">{{$video->views}} views</small> <small class="text-muted pull-right"><a href="{{url('saved-videos/'.$video->id.'/remove')}}" data-toggle="tooltip" data-placement="bottom" data-original-title="Remove from saved videos"><i class="fa fa-trash red-text"></i></a></small> </p>
              </div>
              <!--/.Card content--> 
