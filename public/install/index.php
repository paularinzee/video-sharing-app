...
if (isset($_POST['DB_HOST'])):
    ...
    if ($db->connect_errno > 0) {
        ...
        if ($result) {
            ...
            $db->query("UPDATE setting SET `value`='$site_name' WHERE `key`='site_name'");
            $db->query("UPDATE setting SET `value`='$site_email' WHERE `key`='site_email'");
